...
<div class="panel-body">
    ...
    <div class="form-group required">
        {!! Form::label('login', __('views/dashboard/users/partials/form.login.label')) !!}
        {!! Form::text('login', null, ['class' => 'form-control', 'required' => true, 'autofocus']) !!}
    </div>

    {{-- Full name --}}
    <div class="form-group required">
        {!! Form::label('full_name', __('views/dashboard/users/partials/form.full-name.label')) !!}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group required">
                {!! Form::label('password', __('views/dashboard/users/partials/form.password.label')) !!}
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group required">
                {!! Form::label('password_confirm', __('views/dashboard/users/partials/form.password-confirm.label')) !!}
    ...
    {{-- Status --}}
    <div class="form-group required">
        {!! Form::label('status', __('views/dashboard/users/partials/form.status.label')) !!}
